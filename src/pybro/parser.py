            ...
            if node.func.value.id == 'ui':
                ...
                try:
                    ...
                    # --- Slider ---
                        ...
                        token_type = None
                        logger.debug(f"Ignored unknown ui.{func_name}() at line {lineno}")
                    ...
                    if token_type is not None:
                        ...
                        logger.debug(f"Line {lineno}: created {token_type} node (id={attrs.get('id', 'N/A')})")
                    ...
                    logger.error(f"Error in ui.{func_name}() at line {lineno}: {e}")
                    logger.debug(traceback.format_exc())
                    raise type(e)(f"Line {lineno}: {e}") from e
